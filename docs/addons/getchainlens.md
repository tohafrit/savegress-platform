# GetChainLens — Blockchain & Web3 Add-on

> "See through your smart contracts"

## Overview

GetChainLens — инструмент для разработчиков Web3, который объединяет анализ смарт-контрактов, отладку транзакций и мониторинг on-chain событий. В связке с Savegress CDC обеспечивает полную картину Web3 бизнеса.
...
│   │                                                                  │   │
│   │   PostgreSQL ◄──CDC──► GetChainLens ◄──RPC──► Ethereum/Polygon     │   │
│   │   (off-chain)                              (on-chain)            │   │
│   └─────────────────────────────────────────────────────────────────┘   │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
...
```
┌─────────────────────────────────────────────────────────────────┐
│  Contract: NFTMarketplace.sol                   GetChainLens    │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
