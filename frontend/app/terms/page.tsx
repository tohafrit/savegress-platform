      ...
      <div className="container-custom py-12 md:py-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10">
            <section>
              <h2 className="text-h4 text-white mb-4">1. Agreement to Terms</h2>
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">2. Description of Service</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">3. Account Registration</h2>
              <p className="text-content-1 text-grey mb-4">To use our Service, you must:</p>
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">4. Acceptable Use</h2>
              <p className="text-content-1 text-grey mb-4">You agree not to:</p>
              <ul className="list-disc pl-6 text-content-1 text-grey space-y-2">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">5. Data and Privacy</h2>
              <p className="text-content-1 text-grey mb-4">
                Our collection and use of personal information is governed by our <Link href="/privacy" className="text-cyan hover:text-cyan/80">Privacy Policy</Link>. By using the Service, you consent to such processing and you warrant that all data provided by you is accurate.
              </p>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">6. Payment Terms</h2>
              <ul className="list-disc pl-6 text-content-1 text-grey space-y-2">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">7. Service Level and Support</h2>
              <p className="text-content-1 text-grey mb-4">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">8. Intellectual Property</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">9. Limitation of Liability</h2>
              <p className="text-content-1 text-grey mb-4">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">10. Disclaimer of Warranties</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">11. Indemnification</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">12. Termination</h2>
              <p className="text-content-1 text-grey mb-4">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">13. Governing Law</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">14. Dispute Resolution</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">15. Changes to Terms</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">16. Severability</h2>
              <p className="text-content-1 text-grey">
            ...
            <section>
              <h2 className="text-h4 text-white mb-4">17. Contact Us</h2>
              <p className="text-content-1 text-grey mb-4">
